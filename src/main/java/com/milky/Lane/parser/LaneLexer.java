...
public class LaneLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__25", "T__26", "T__27", "T__28", "T__29", "NUM", "STRING", "INCOMPLETE_STRING", 
			"ESCAPE_SEQ", "OCT_ESCAPE", "UNICODE_ESCAPE", "HEX_DIGIT", "OCT_DIGIT", 
			"BOOL", "TYPELIT", "START_CHAR", "ID", "WS"
		};
	}
	...
	public LaneLexer(CharStream input) {
		super(input);
